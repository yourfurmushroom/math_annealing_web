...
export default function Home() {
    ...
    useEffect(() => {
        ...
        const buildUrl = "/annealing/containerGame/Build";
        const loaderUrl = buildUrl + "/containerGame.loader.js";

        const config = {
            dataUrl: buildUrl + "/containerGame.data",
            frameworkUrl: buildUrl + "/containerGame.framework.js",
            codeUrl: buildUrl + "/containerGame.wasm",
            streamingAssetsUrl: "StreamingAssets",
            companyName: "DefaultCompany",
            productName: "containerGame",
            productVersion: "1.0",
